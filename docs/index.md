...
- **Calculation of the recombination coefficient (ku)** on the metal membrane surface.
...
### Reference
For more details on the permeation probe used in this measurement, please refer to:
